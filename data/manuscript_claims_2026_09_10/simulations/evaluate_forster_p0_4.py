...
Output:
  simulations/forster_p0_4_uncertainty_convergence.json
"""
...
OUT = ROOT / "simulations" / "forster_p0_4_uncertainty_convergence.json"
MODE_CUTOFF = 1e-6
...
def main() -> None:
    ...
    reference_bounded_validation = {
        ...
        "pulse_reoptimization_provenance": (
            "simulations/optimize_forster_p0_4_reference.py; deterministic accepted "
    ...
    result = {
        ...
        "fixed_inputs": {
            ...
            "pulse_reoptimized": True,
            "pulse_provenance": (
                "selected by simulations/optimize_forster_p0_4_reference.py on the "
