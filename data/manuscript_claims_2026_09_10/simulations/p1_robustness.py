...
def sobol_scenarios(
    power: int,
    domain: RobustnessDomain = RobustnessDomain(),
    *,
    scramble: bool = False,
    seed: int | None = None,
...
def local_adversarial_search(
    ...
    *,
    ...
    and then re-evaluate the returned candidates with the full Hamiltonian.
    """
...
def sample_harmonic_phase_space(
    ...
    *,
    ...
    position_width, velocity_width = harmonic_phase_space_widths(
...
def sample_two_species_phase_space(
    ...
    *,
    ...
    return TwoSpeciesPhaseSpace(
        yb=sample_harmonic_phase_space(
            yb_state, sample_count, rng, quantum=quantum
        ),
        rb=sample_harmonic_phase_space(
            rb_state, sample_count, rng, quantum=quantum
        ),
    )
